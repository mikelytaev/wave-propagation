...
petool_vis_elevated = FieldVisualiser(petool_field_elevated, env=env, trans_func=lambda x: 2 * x, label='Метод расщ. Фурье', x_mult=1E-3)
plt = petool_vis_elevated.plot2d(0, -100, True)
plt.show()