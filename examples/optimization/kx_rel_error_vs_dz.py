...
k_x_2 = k_x(k_z=k_z, dx=300, pade_order=(7, 8), dz=dzs, z_order=2, alpha=0)
k_x_2_4 = k_x(k_z=k_z, dx=300, pade_order=(7, 8), dz=dzs, z_order=4, alpha=0)

plt.figure(figsize=(6, 3.2))
plt.plot(dzs, (np.abs(k_x_2 - k_x_r))/k0, label='[7/8], 2-d order by z')
plt.plot(dzs, (np.abs(k_x_2_4 - k_x_r))/k0, label='[7/8], 4-d order by z')
