...
plt.plot(angles, (k_x_1 / k0).real, label='[1/1], 2-d order by z')
plt.plot(angles, (k_x_2 / k0).real, label='[4/4], 2-d order by z')
plt.plot(angles, (k_x_3 / k0).real, label='[8/8], 2-d order by z')
plt.plot(angles, (k_x_4 / k0).real, label='[8/8], 4-d order by z')
plt.plot(angles, (k_x_5 / k0).real, label='[8/8], Pade order by z')
plt.plot(angles, (k_x_r / k0).real, '--', label='original Helmholtz eq.')
plt.xlabel('Propagation angle')
plt.ylabel('re(k_x / k)')
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.figure(figsize=(5,4))
plt.plot(angles, (np.abs(k_x_1 - k_x_r) / np.abs(k_x_r)), label='[1/1], 2-d order by z')
plt.plot(angles, (np.abs(k_x_2 - k_x_r) / np.abs(k_x_r)), '--', label='[4/4], 2-d order by z')
plt.plot(angles, (np.abs(k_x_3 - k_x_r) / np.abs(k_x_r)), label='[8/8], 2-d order by z')
plt.plot(angles, (np.abs(k_x_4 - k_x_r) / np.abs(k_x_r)), '--', label='[8/8], 4-d order by z')
plt.plot(angles, (np.abs(k_x_5 - k_x_r) / np.abs(k_x_r)), label='[8/8], Pade order by z')
plt.xlabel('Propagation angle')
...
plt.plot(k_z / k0, (k_x_r / k0).real, '--', label='original Helmholtz eq.')
plt.xlabel('k_z / k')
plt.ylabel('re(k_x / k)')
plt.legend()
plt.grid(True)
...
plt.plot(k_z / k0, (k_x_r / k0).imag, '--', label='original Helmholtz eq.')
plt.xlabel('k_z / k')
plt.ylabel('im(k_x / k)')
plt.legend()
plt.grid(True)
