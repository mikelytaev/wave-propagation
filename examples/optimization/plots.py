...
plt.plot(angles, (k_x_r / k0).real, '--', label='original Helmholtz')
...
plt.plot(k_z / k0, (k_x_r / k0).real, '--', label='original Helmholtz')
plt.xlabel('k_z / k')
plt.ylabel('re(k_x / k)')
plt.legend()
plt.grid(True)
...
plt.plot(k_z / k0, (k_x_r / k0).imag, '--', label='original Helmholtz')
plt.xlabel('k_z / k')
plt.ylabel('im(k_x / k)')
plt.legend()
plt.grid(True)
