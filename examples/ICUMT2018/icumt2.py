...
ant = GaussAntenna(freq_hz=30000e6, height=10, beam_width=20, eval_angle=0, polarz='H')
max_range = 300
pade12_task = TroposphericRadioWaveSSPadePropagator(antenna=ant, env=env, two_way=False, max_range_m=max_range, pade_order=(7, 8),
...
pade12_task_tw = TroposphericRadioWaveSSPadePropagator(antenna=ant, env=env, two_way=True, max_range_m=max_range, pade_order=(7, 8),
                                                       dx_wl=1, n_dx_out=10, dz_wl=0.25, n_dz_out=80)
