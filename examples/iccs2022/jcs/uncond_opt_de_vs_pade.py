...
arr = []
def calc(dx, dz, bounds, theta_max_degrees, order, mutation=(0.5, 1), recombination=1.0, strategy='randtobest1exp', popsize=15, max_evals=1e6):
...
arr1 = calc(dx=50.0, dz=0.25, theta_max_degrees=22, order=(6, 7), bounds=(-50, 50), popsize=15, max_evals=0.5e6)
