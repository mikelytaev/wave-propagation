...
env = EarthAtmosphereEnvironment(boundary_condition=VeryDryGroundBC(), height=300)
...
ant = GaussSource(freq_hz=3000e6, height=30, beam_width=2, eval_angle=0, polarz='H')
max_range = 100000
...
petool_task = PETOOLPropagationTask(src=ant, env=env, two_way=False, max_range_m=max_range, dx_wl=400, n_dx_out=1, dz_wl=3)
