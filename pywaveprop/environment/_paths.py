...
bathymetry, Argo profiles) is cached under a single root so users can share a
single cache across projects and purge it in one place.
"""
...
def set_cache_root(root: str | Path) -> None:
    ...
    global BATHYMETRY_CACHE_DIR, ARGO_CACHE_DIR
